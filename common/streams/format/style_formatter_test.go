...
func TestBold(t *testing.T) {
	builder := NewStyleFormatter().Bold()
...
func TestUnderlined(t *testing.T) {
	builder := NewStyleFormatter().Underlined()
...
func TestBoldAndUnderlined(t *testing.T) {
	builder := NewStyleFormatter().Bold().Underlined()
...
func TestColoredText(t *testing.T) {
	builder := NewStyleFormatter().Color(colors.Red)
...
func TestBoldAndColored(t *testing.T) {
	builder := NewStyleFormatter().Bold().Color(colors.Red)
	expected := "\033[1;38;5;9mThis is bold and red text\033[0m"
...
func TestMultipleStyles(t *testing.T) {
	builder := NewStyleFormatter().Bold().Underlined().Color(colors.Yellow)
	expected := "\033[1;4;38;5;190mThis is bold, underlined, and yellow text\033[0m"
