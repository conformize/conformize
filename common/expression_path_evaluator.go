...
type IterFnNodeValue struct {
	Fn   func(it typed.Iterable, p predicates.Predicate) (bool, error)
	Iter typed.Iterable
}

func (vpeval *ExpressionPathEvaluator) Evaluate(node *ds.Node[string, interface{}], p *path.Path) (*ds.Node[string, interface{}], error) {
