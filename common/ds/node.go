...
func (n *Node[K, V]) UnmarshalYAML(unmarshal func(interface{}) error) error {
...
func unmarshalYAMLItem[K comparable, V any](value interface{}, node *Node[K, V]) {
...
func unmarshalValue[K comparable, V any](nodeRef *Node[K, V], value interface{}) {
	if valMap, ok := value.(map[K]interface{}); ok {
