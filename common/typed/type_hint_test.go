...
func TestTypeHintOf(t *testing.T) {
	tests := []struct {
		...
		{[]interface{}{1, "two"}, &complexTypeMixedElementsHint{kind: Tuple, elementsType: []TypeHinter{&simpleTypeHint{kind: Number}, &simpleTypeHint{kind: String}}}},
	}
...
func TestNativeTypeForTypeHint(t *testing.T) {
	tests := []struct {
		...
		{&complexTypeHint{kind: List, elemType: &simpleTypeHint{kind: Generic}}, reflect.TypeOf([]interface{}{})},
		{&complexTypeHint{kind: Tuple, elemType: &simpleTypeHint{kind: Generic}}, reflect.TypeOf([]interface{}{})},
		{&complexTypeHint{kind: Map, elemType: &simpleTypeHint{kind: Generic}}, reflect.TypeOf(map[string]interface{}{})},
		{&simpleTypeHint{kind: Object}, reflect.TypeOf(struct{}{})},
		{&complexTypeHint{kind: Variant, elemType: &simpleTypeHint{kind: Generic}}, reflect.TypeOf((*interface{})(nil)).Elem()},
		{&simpleTypeHint{kind: Generic}, reflect.TypeOf((*interface{})(nil)).Elem()},
