...
func (listHasNoDupPrd *ListHasNoDuplicateElementsPredicate) Test(value typed.Valuable) (bool, error) {
	valid, validErr := listHasNoDupPrd.Validate(value, listHasNoDupPrd.Args, listHasNoDupPrd.Schema())
	if !valid {
...
func (listHasNoDupPrd *ListHasNoDuplicateElementsPredicate) ArgumentsLength() int {
	return 0
}

func (listHasNoDupPrd *ListHasNoDuplicateElementsPredicate) Arguments(args *typed.TupleValue) {
	listHasNoDupPrd.Args = args
}
