...
func (listContainsAllPrd *ListContainsAllElementsPredicate) Test(value typed.Valuable) (bool, error) {
	...
	elementsListVal := listContainsAllPrd.Args.(*typed.ListValue)
...
func (listContainsAllPrd *ListContainsAllElementsPredicate) ArgumentsCount() int {
	return 1
}

func (listContainsAllPrd *ListContainsAllElementsPredicate) Arguments(args typed.Valuable) {
