...
func (valIsNotEqPrd *ValueIsNotEqualPredicate) Test(value typed.Valuable) (bool, error) {
	valEqPrd := &ValueIsEqualPredicate{Args: valIsNotEqPrd.Args}
	equal, err := valEqPrd.Test(value)
	return !equal && err == nil, err
}

func (valIsEqPrd *ValueIsNotEqualPredicate) ArgumentsLength() int {
	return 1
}

func (valIsEqPrd *ValueIsNotEqualPredicate) Arguments(args *typed.TupleValue) {
