...
func (valIsNotEqPrd *ValueIsNotEqualPredicate) Test(value typed.Valuable, args *typed.TupleValue) (bool, error) {
	valEqPrd := &ValueIsEqualPredicate{}
	equal, err := valEqPrd.Test(value, args)
	return !equal && err == nil, err
}

func (valIsEqPrd *ValueIsNotEqualPredicate) Arguments() int {
	return 1
}
