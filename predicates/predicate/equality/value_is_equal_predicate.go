...
func (valIsEqPrd *ValueIsEqualPredicate) ArgumentsLength() int {
	return len(valIsEqPrd.Args.Elements)
}

func (valIsEqPrd *ValueIsEqualPredicate) Arguments(args *typed.TupleValue) {
