...
func (dateIsBeforePrd *DateIsBeforePredicate) Test(value typed.Valuable) (bool, error) {
	valid, validErr := dateIsBeforePrd.Validate(value, dateIsBeforePrd.Args, dateIsBeforePrd.Schema())
	if !valid {
	...
	oDateArg := dateIsBeforePrd.Args.Elements[0]
	var oDateVal string
...
func (dateIsBeforePrd *DateIsBeforePredicate) ArgumentsLength() int {
	return 1
}

func (dateIsBeforePrd *DateIsBeforePredicate) Arguments(args *typed.TupleValue) {
