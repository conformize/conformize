...
func (dateIsBeforePrd *DateIsBeforePredicate) Test(value typed.Valuable, args *typed.TupleValue) (bool, error) {
	valid, validErr := dateIsBeforePrd.Validate(value, args, dateIsBeforePrd.Schema())
	if !valid {
...
func (dateIsBeforePrd *DateIsBeforePredicate) Arguments() int {
	return 1
}
