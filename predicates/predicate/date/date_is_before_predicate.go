...
func (dateIsBeforePrd *DateIsBeforePredicate) ArgumentsCount() int {
	return 1
}

func (dateIsBeforePrd *DateIsBeforePredicate) Arguments(args typed.Valuable) {
