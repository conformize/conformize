...
func (dateFromPredicate *DateFromPredicate) Test(value typed.Valuable) (bool, error) {
	...
	var oDateVal string
	oDateArg := dateFromPredicate.Args
...
func (dateFromPredicate *DateFromPredicate) ArgumentsCount() int {
	return 1
}

func (dateFromPredicate *DateFromPredicate) Arguments(args typed.Valuable) {
