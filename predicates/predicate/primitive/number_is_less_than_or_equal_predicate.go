...
func (numLessOrEqPrd *NumberIsLessThanOrEqualPredicate[T]) Test(value typed.Valuable, args *typed.TupleValue) (bool, error) {
	valid, validErr := numLessOrEqPrd.Validate(value, args, numLessOrEqPrd.Schema())
	if !valid {
...
func (numLessOrEqPrd *NumberIsLessThanOrEqualPredicate[T]) Arguments() int {
	return 1
}
