...
func TestBooleanIsEqualPredicate(t *testing.T) {
	...
	tests := []struct {
			...
			args: args{
				...
				args: &typed.TupleValue{
					Elements: []typed.Valuable{
						tests.PrimVal(true, &typed.BooleanTyped{}),
					},
		...
		},
		{
			...
			args: args{
				...
				args: &typed.TupleValue{
					Elements: []typed.Valuable{
						tests.PrimVal(false, &typed.BooleanTyped{}),
					},
					ElementsTypes: []typed.Typeable{&typed.BooleanTyped{}},
				},
			},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			boolEqPrd.Arguments(tt.args.args)
			got, err := boolEqPrd.Test(tt.args.value)
...
func TestBooleanIsEqualPredicate_Arguments(t *testing.T) {
	tests := []struct {
		name      string
		boolEqPrd *primitive.BooleanIsEqualPredicate
		want      int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := boolEqPrd.ArgumentsLength(); got != tt.want {
				t.Errorf("BooleanIsEqualPredicate.Arguments() = %v, want %v", got, tt.want)
			}
		})
	}
}
