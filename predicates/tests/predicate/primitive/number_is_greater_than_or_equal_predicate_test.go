...
func TestNumberIsGreaterThanOrEqualPredicate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := numGtOrEqPrd.Test(tt.args.value, tt.args.args)
			if (err != nil) != tt.wantErr {
				t.Errorf("StringHasLengthGreaterOrEqualPredicate.Test() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("StringHasLengthGreaterOrEqualPredicate.Test() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestNumberIsGreaterThanOrEqualPredicate_Arguments(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := numGtOrEqPrd.Arguments(); got != tt.want {
				t.Errorf("StringHasLengthGreaterOrEqualPredicate.Arguments() = %v, want %v", got, tt.want)
			}
		})
	}
}
