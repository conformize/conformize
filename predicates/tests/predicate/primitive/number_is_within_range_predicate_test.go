...
func TestNumberIsWithinRangePredicate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			numWithinRangePrd.Arguments(tt.args.args)
			got, err := numWithinRangePrd.Test(tt.args.value)
...
func TestNumberIsWithinRangePredicate_Arguments(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := numWithinRangePrd.ArgumentsLength(); got != tt.want {
				t.Errorf("NumberIsWithinRangePredicate.Arguments() = %v, want %v", got, tt.want)
			}
		})
	}
}
