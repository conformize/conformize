...
var predicateBuilders = &PredicateBuilderFuncsMap{
	...
	condition.CONTAINS_ANY: func(prdBuilder predicates.PredicateBuilder) predicates.Predicate {
		return &list.ListContainsAnyOfElementsPredicate{PredicateBuilder: prdBuilder}
	},
	condition.CONTAINS_ALL: func(prdBuilder predicates.PredicateBuilder) predicates.Predicate {
