...
var predicateBuilders = &PredicateBuilderFuncsMap{
	...
	condition.NEQ: func(prdBuilder predicates.PredicateBuilder) predicates.Predicate {
	...
	condition.HAS_ALL: func(prdBuilder predicates.PredicateBuilder) predicates.Predicate {
