...
type CommandHandler interface {
	Handle(cmd CommandEntry, args []string, diags diagnostics.Diagnosable)
}
...
type CommandEntry interface {
	...
	IsHidden() bool
	GetMeta() *schema.Data
	Run(args []string, diags diagnostics.Diagnosable)
}
...
func (c *Command) Run(args []string, diags diagnostics.Diagnosable) {
	if c.Handler != nil {
