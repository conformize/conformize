...
func NewAggregateProvider(alias string, valRefStore *valuereferencesstore.ValueReferencesStore, providersDependenciesGraph *ds.DependencyGraph[string]) *AggregateProvider {
