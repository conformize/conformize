...
func (mr *MockConsulClientMockRecorder) KV() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "KV", reflect.TypeOf((*MockConsulClient)(nil).KV))
}
...
func (mr *MockKVMockRecorder) Get(key, q interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockKV)(nil).Get), key, q)
}
...
func (mr *MockKVMockRecorder) List(prefix, q interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockKV)(nil).List), prefix, q)
}
