...
func (awsSecretsManagerPrvdr *AwsSecretsManagerProvider) Provide(req *sdk.ProviderDataRequest) (*ds.Node[string, interface{}], *diagnostics.Diagnostics) {
	...
	var data *ds.Node[string, interface{}]
	var err error
...
func getSecretValue(client *secretsmanager.Client, queryOptions *awsSecretsManagerQueryOptions) (*ds.Node[string, interface{}], error) {
...
func getSecretValuesBatch(client *secretsmanager.Client, queryOptions *awsSecretsManagerQueryOptions) (*ds.Node[string, interface{}], error) {
			...
			for _, secretValue := range secretValuesBatch.SecretValues {
				...
				go func(secretValue types.SecretValueEntry) {
					...
					for step, hasNext := steps.Next(); hasNext; step, hasNext = steps.Next() {
						...
						rwLock.RLock()
						nodeRef, found := lastNodeRef.GetChild(stepName)
						rwLock.RUnlock()
...
func New() sdk.ConfigurationProvider {
