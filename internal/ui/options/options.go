...
var optionsMap = map[string]optionSetter{
	"plain": func(data *schema.Data, _ interface{}) error {
	...
	"no-beauty-sleep": func(data *schema.Data, _ interface{}) error {
		return data.SetAtPath("ui.beauty-sleep", false)
	},
	"no-timestamps": func(data *schema.Data, _ interface{}) error {
