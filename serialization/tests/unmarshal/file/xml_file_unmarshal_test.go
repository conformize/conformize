...
func testXmlFileUnmarshalling(filePath string) (*ds.Node[string, interface{}], error) {
	var fileSource, _ = serialization.NewFileSource(filePath)
	var xmlFileUnmarshal = xml.NewXmlFileUnmarshal(fileSource)
	return xmlFileUnmarshal.Unmarshal()
}
