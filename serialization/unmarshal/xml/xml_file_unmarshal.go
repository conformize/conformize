...
func (xmlUnmarshal *XmlFileUnmarshal) Unmarshal() (*ds.Node[string, interface{}], error) {
	var fileContent, err = xmlUnmarshal.fileSource.Read()
	if err != nil {
		return nil, err
	}
...
func NewXmlFileUnmarshal(fileSource *serialization.FileSource) *XmlFileUnmarshal {
	return &XmlFileUnmarshal{fileSource: fileSource}
}
