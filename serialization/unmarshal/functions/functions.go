...
func UnmarshalValue[K comparable, V any](nodeRef *ds.Node[K, V], value interface{}) {
	if val, ok := value.(map[K]interface{}); !ok {
...
func DecodeStringValue(value string) (interface{}, error) {
